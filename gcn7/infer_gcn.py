#!/usr/bin/env python3
"""
Edge-Weighted GCN Inference Example (7层 + 128维 + 边权重版本)
...
def main(data_tag: str = None, training_timestamp: str = None, suffix: str = "", model_path: Path = None, scaler_path: Path = None, config: dict = None, config_path: Path = None, metrics_path: Path = None):
    ...
    # Configuration
    output_dir = resolve_output_dir(config) if config else Path("/home/hu/Diana-Sim/gcn7")
    ...
    log_msg("="*70)
    log_msg("Edge-Weighted GCN Inference Log (7-Layer + 128D + Edge Weights)")
    log_msg("="*70)
    log_msg("")
...
if __name__ == "__main__":
    ...
    output_dir = Path("/home/hu/Diana-Sim/gcn7")  # 默认输出目录
